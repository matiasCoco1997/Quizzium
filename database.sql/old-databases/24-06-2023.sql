...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-06-2023 a las 09:20:51
...
INSERT INTO `cuenta` (`id_cuenta`, `id_genero`, `id_rol`, `fecha_creacion`, `mail`, `ciudad`, `pais`, `usuario`,
                      `contrasenia`, `foto_perfil`, `fecha_nacimiento`, `nombre`, `apellido`, `esta_activa`,
                      `fecha_validacion`, `token`, `cantidad_respuestas`, `cantidad_correctas`, `dificultad`, `lat`,
                      `lng`)
VALUES (1, 1, 1, '2023-05-23 23:34:56', 'administrador@gmail.com', 'Ituzaingo', 'Argentina', 'Matias',
        '202cb962ac59075b964b07152d234b70', '6473d9bb6ccf5_foto para probar.png', '1997-12-14', 'Matías', 'Coco', 1,
        '2023-05-23 23:34:56', NULL, 34, 21, 61.7647, -34.6699, -58.5619),
       (2, 2, 2, '2023-04-23 23:38:01', 'editor@gmail.com', 'Ramos Mejia', 'Argentina', 'victoria',
        '202cb962ac59075b964b07152d234b70', '6473d9c91d273_foto para probar.png', '2021-11-21', 'Victoria', 'Gambaro',
        1, '2023-05-23 23:38:01', NULL, 5, 3, 60, -34.6596, -58.6665),
       (3, 3, 3, '2023-05-05 23:38:01', 'jugador@gmail.com', 'Liniers', 'Argentina', 'Nuria',
        '202cb962ac59075b964b07152d234b70', '6473d9d04d766_foto para probar.png', '1997-06-24', 'Nuria', 'Orquin', 1,
        '2023-05-23 23:38:01', NULL, 0, 0, 100, -34.6364, -58.5287),
       (6, 2, 3, '2023-06-24 03:43:07', 'n.r.orquin@gmail.com', '', 'Brasil', 'norquin',
        '202cb962ac59075b964b07152d234b70', '6496664b24651_avatar-mujer.png', '1940-06-24', 'Nu', 'Orquin', 1,
        '2023-06-24 03:43:21', '6496664b247e8', 0, 0, 100, -34.6363, -58.529);
...
INSERT INTO `genero` (`id_genero`, `tipo`)
VALUES (1, 'Masculino'),
       (2, 'Femenino'),
...
INSERT INTO `juego` (`id_juego`, `id_partida`, `id_cuenta`, `puntaje`)
VALUES (1, 3, 1, 2),
       (2, 4, 1, 0),
       (3, 7, 1, 0),
       (4, 8, 1, 1),
...
INSERT INTO `opcion` (`id_opcion`, `id_pregunta`, `opcion`, `es_correcta`)
VALUES (1, 1, 'Amazonas', 1),
       (2, 1, 'Nilo', 0),
       (3, 1, 'Misisipi', 0),
       (4, 1, 'Yangtsé', 0),
       (5, 2, 'Mercurio', 1),
...
INSERT INTO `partida` (`id_partida`, `fecha_partida`, `fue_aceptada`)
VALUES (1, '2023-06-10 11:39:46', 1),
...
INSERT INTO `pregunta` (`id_pregunta`, `id_categoria`, `fecha_creacion`, `esta_activa`, `pregunta`, `veces_respondida`,
                        `veces_incorrecta`, `dificultad`)
VALUES (1, 4, '2023-06-01 03:46:27', 1, '¿Cuál es el río más largo del mundo?', 4, 1, 25),
       (2, 1, '2023-06-01 03:46:27', 1, '¿Cuál es el planeta más cercano al Sol?', 0, 0, 100),
       (3, 1, '2023-06-01 03:46:27', 1, '¿Cuál es el elemento químico más abundante en la corteza terrestre?', 0, 0,
        100),
       ...
       (20, 5, '2023-06-01 05:12:27', 1, '¿Cuál es el nombre del protagonista de la película \"The Dark Knight\"?', 0,
        0, 100),
       ...
       (30, 6, '2023-06-01 05:16:40', 1, '¿Cuál es el tenista con más títulos de Grand Slam en la historia?', 0, 0,
        100),
       ...
       (40, 1, '2023-06-01 05:20:20', 1,
        '¿Cuál es el órgano responsable de la circulación de la sangre en el cuerpo humano?', 0, 0, 100),
       ...
       (59, 2, '2023-06-01 05:32:04', 1, '¿Cuál fue la batalla que marcó el fin del Imperio Romano de Occidente?', 0, 0,
        100),
       ...
       (71, 5, '2023-06-01 05:35:52', 1, '¿Quién interpretó el papel de Iron Man en las películas de Marvel?', 0, 0,
        100),
       ...
       (87, 4, '2023-06-01 05:45:05', 1, '¿Cuál es el país más pequeño del mundo?', 1, 1, 0),
       ...
       (93, 6, '2023-06-01 05:46:03', 1, '¿Cuál es el tenista con más títulos de Grand Slam en la historia?', 0, 0,
        100),
       ...
       (96, 5, '2023-06-01 05:46:45', 1,
        '¿Quién interpretó a Iron Man en las películas del Universo Cinematográfico de Marvel?', 0, 0, 100),
       (97, 5, '2023-06-01 05:46:45', 1, '¿Cuál es la película más taquillera de todos los tiempos?', 0, 0, 100),
       (98, 5, '2023-06-01 05:46:45', 1, '¿En qué saga cinematográfica aparece el personaje Luke Skywalker?', 0, 0,
        100),
...
INSERT INTO `reporte` (`id_reporte`, `id_cuenta`, `id_pregunta`, `fecha_reporte`, `descripcion`, `fue_visto`)
VALUES (1, 1, 92, '2023-06-18 23:35:06', 'hola', 1),
...
INSERT INTO `respuesta` (`id_respuesta`, `id_pregunta`, `id_cuenta`, `fecha_respuesta`, `fue_correcta`)
VALUES (22, 72, 2, '2023-06-10 22:31:28', 1),
...
INSERT INTO `sugerencia` (`id_sugerencia`, `id_cuenta`, `id_pregunta`, `fecha_sugerencia`, `fue_visto`)
VALUES (1, 1, 114, '2023-06-19 18:42:26', 0);
...
--
ALTER TABLE `juego`
    MODIFY `id_juego` int (11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=227;
...
--
ALTER TABLE `partida`
    MODIFY `id_partida` int (11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=231;
